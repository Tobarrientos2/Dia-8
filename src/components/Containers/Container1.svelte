...
<div class="flex flex-col items-center justify-center bg-[#F5F5F4]">
    <div class="z-[1] flex h-fit w-full flex-col items-center justify-center">
        ...
        >
            ...
            >
                ...
                <div class="flex flex-col gap-y-4">
                    ...
                    <div class="flex flex-row gap-3">
                        <button
                            class="cursor-pointer flex none box-border select-none hover:opacity-80 items-center gap-2 border px-4 py-2 rounded-[14px] w-fit"
                            data-projection-id="385"
            ...
            <div class="relative w-full">
                <div
                    ...
                    data-projection-id="411"
                >
                    <div
                        class="hidden h-full w-[240px] flex-col gap-y-4 bg-[#F5F5F5] p-3 pb-40 lg:flex"
                    >
                        ...
                        <div class="h flex flex-col gap-[2px]">
                            ...
                            >
                                ...
                                <span class="body-small text-black">Inbox</span>
                            </div>
                            <div
                                class=" box-border flex h-8 items-center gap-x-0.5 rounded-[6px] px-1 py-1.5"
                                style="padding-left: 0px;"
                    ...
                    <div class="flex w-full flex-col overflow-hidden">
                        <div class="w-full px-5 py-3">
                            <span class="font-size-[15px] font-sans font-bold"
                                >Inbox <span class="text-orange-500">12</span
                                ></span
                            >
                        </div>
                        <div class="w-full px-4">
                            <div
                                class="box-border h-fit w-full rounded-xl bg-[var(--bg-overlay-tertiary)] px-3 py-1.5"
                            >
                        ...
                        <div class="relative w-full">
                            <div class="absolute right-4 top-2">
                                <span
                                    class="caption w-fit self-end font-mono text-gray-400"
                                    >02:15 PM</span
                                >
                            </div>
                        </div>
                        <div
                            class="flex w-full items-start gap-x-5 border-b-[1px] border-gray-100 border-opacity-90 bg-white px-5 py-3"
                        >
                            ...
                            <div
                                class="box-border flex w-full max-w-[290px] flex-col gap-y-0.5 overflow-hidden"
                            >
                                <div class="flex items-center gap-x-1">
                                    <span class="body-small text-gray-600 w-36"
                                        >Heinrich Lox</span
                                    >
                                </div>
                                <div
                                    class="flex w-full items-center gap-x-2 overflow-hidden"
                                >
                                    <span
                                        class="caption text-gray-600 flex flex-col gap-y-0.5 overflow-hidden overflow-ellipsis whitespace-nowrap"
                                        >Update to engineering status<span
                                            class="caption text-gray-400"
                                            >Hey all, After touching base with
                                            Laura:</span
                                        ></span
                                    >
                                </div>
                                ...
                                >
                                    <span
                                        ...
                                        >Product strategy sync<span
                                            class="caption text-gray-400"
                                            >Hey Jo, will you be joining us this
                                            call?</span
                                        ></span
                                    >
                                </div>
                        ...
                        >
                            ...
                            >
                                <div class="flex items-center gap-x-1">
                                    <span class="body-small text-black w-36"
                                ...
                                >
                                    <span
                                        class="caption text-black flex flex-col gap-y-0.5 overflow-hidden overflow-ellipsis whitespace-nowrap"
                                        >Rewind Feature Eng Sync<span
                                            class="caption text-gray-400"
                                            >I'm not entirely sure I agree with
                                            that approach. Users won't
                                            understand!</span
                                        ></span
                                    >
                                </div>
                                ...
                                >
                                    <span
                                        ...
                                        >Where to find contract agreement?<span
                                            class="caption text-gray-400"
                                            >Hey Jason, you mentioned the other
                                            day that there was an archival
                                            Sketch file for the original email
                                            mocks.</span
                                        ></span
                                    >
                                </div>
                            ...
                            >
                                ...
                                >
                                    <span
                                        ...
                                        >Upcoming event<span
                                            class="caption text-gray-400"
                                            >Don't miss out! Join us for our
                                            upcoming event.</span
                                        ></span
                                    >
                                </div>
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <span
                                        class="caption text-black flex flex-col gap-y-0.5 overflow-hidden overflow-ellipsis whitespace-nowrap"
                                        >Meeting Tomorrow at 2 PM<span
                                            class="caption text-gray-400"
                                            >lease let me know if you need to
                                            reschedule.</span
                                        ></span
                                    >
                                </div>
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <span
                                        class="caption text-black flex flex-col gap-y-0.5 overflow-hidden overflow-ellipsis whitespace-nowrap"
                                        >Confirmation of Payment Received<span
                                            class="caption text-gray-400"
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <span
                                        class="caption text-black flex flex-col gap-y-0.5 overflow-hidden overflow-ellipsis whitespace-nowrap"
                                        >New Product Launch<span
                                            class="caption text-gray-400"
                                            >We would be delighted if you could
                                            attend our launch event.</span
                                        ></span
                                    >
                                </div>
                            </div>
